...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Base de datos reactiva global que se sincronizará con Firestore
    let GUEST_DATABASE = [];
    ...
    async function loadGuestsFromFirestore() {
        try {
            ...
            if (querySnapshot.empty) {
                ...
                const INITIAL_GUEST_DATABASE = [
                    { name: "Kory Cacho", passes: 13, table: "Mesa 12 Y 13", status: "pending" },
                    { name: "Andres Rodas", passes: 4, table: "Mesa 11", status: "pending" },
                    { name: "Angel Abundio Correa", passes: 1, table: "Mesa 11", status: "pending" },
                    { name: "Briseño Gallardo Marjhori", passes: 1, table: "Mesa 4", status: "pending" },
                    { name: "Alva Montoya Jheremy", passes: 1, table: "Mesa 4", status: "pending" },
                    { name: "Katherine Chalan Briones", passes: 1, table: "Mesa 4", status: "pending" },
                    { name: "Wilman Cotrina", passes: 3, table: "Mesa 18", status: "pending" },
                    { name: "Ever Garcia Machuca", passes: 3, table: "Mesa 18", status: "pending" },
                    { name: "Hector Saldaña Diaz", passes: 3, table: "Mesa 14", status: "pending" },
                    { name: "Rodrigo Saldaña Abanto", passes: 1, table: "Mesa 14", status: "pending" },
                    { name: "Luis Fernando Saldaña Diaz", passes: 4, table: "Mesa 16", status: "pending" },
                    { name: "Carlos Armas Asenjo", passes: 4, table: "Mesa 16", status: "pending" },
                    { name: "Jesus Zamora Diaz", passes: 3, table: "Mesa 15", status: "pending" },
                    { name: "Juan Mera Silva", passes: 3, table: "Mesa 14", status: "pending" },
                    { name: "Pepe Saldaña Delgado", passes: 4, table: "Mesa 15", status: "pending" },
                    { name: "Cesar Cotrina", passes: 3, table: "Mesa 17", status: "pending" },
                    { name: "Fredy Azañero", passes: 4, table: "Mesa 17", status: "pending" },
                    ...
                    { name: "Abelino Llanos", passes: 2, table: "Mesa 5", status: "pending" },
                    { name: "Kenny Llanos Rimarachin", passes: 4, table: "Mesa 7", status: "pending" },
                    { name: "José Fernando Llanos Rimarachin", passes: 4, table: "Mesa 5", status: "pending" },
                    { name: "Jonathan Llanos Rimarachin", passes: 2, table: "Mesa 5", status: "pending" },
                    { name: "Baciano Llanos Murga", passes: 1, table: "Mesa 6", status: "pending" },
                    { name: "Diana Llanos Teran", passes: 2, table: "Mesa 6", status: "pending" },
                    { name: "William Llanos Teran", passes: 4, table: "Mesa 6", status: "pending" },
                    { name: "Luis Alberto Chumpitas Teran", passes: 3, table: "Mesa 10", status: "pending" },
                    { name: "Isabel Llanos Murga", passes: 2, table: "Mesa 7", status: "pending" },
                    { name: "Ronal Chilon", passes: 3, table: "Mesa 8", status: "pending" },
                    { name: "Wilman Lopez Llanos", passes: 4, table: "Mesa 10", status: "pending" },
                    { name: "Jorge Luis Villarreal", passes: 5, table: "Mesa 11", status: "pending" },
                    { name: "Cristobal Gutierrez", passes: 2, table: "Mesa 7", status: "pending" },
                    { name: "Segundo Quiroz", passes: 2, table: "Mesa 2", status: "pending" },
                    { name: "Rosario Quiliche", passes: 2, table: "Mesa 2", status: "pending" },
                    { name: "Gladys Linares Alaya", passes: 2, table: "Mesa 2", status: "pending" },
                    { name: "Alex Fernando Quiliche Rudas", passes: 1, table: "Mesa 3", status: "pending" },
                    { name: "Hanz Chavez Marin", passes: 1, table: "Mesa 3", status: "pending" },
                    { name: "Segundo Chalan Valencia", passes: 1, table: "Mesa 1", status: "pending" },
                    { name: "Cesar Chalan Llanos", passes: 1, table: "Mesa 1", status: "pending" },
                    { name: "Luis Chuquitucto", passes: 5, table: "Mesa 9", status: "pending" },
                    { name: "Grupo LOS MÍSTICOS", passes: 6, table: "Mesa 21", status: "pending" }
                ];
